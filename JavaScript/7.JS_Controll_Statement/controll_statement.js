/*
    if else 문
    - 조건식이 true일 때 if 문의 코드 블럭을 실행, false면 else문 코드 블럭 실행
...
/*
    ...
    - 표현식과 일치하는 값이 없으면 default문으로 이동 (default문이 있을 경우)
...
/*
    break 문 
    - swich 혹은 반복문에서 코드 블럭을 강제로 탈출 하고자 할 때 사용하는 키워드
*/
while (true) {
    console.log('반복중~~~');
    break;
